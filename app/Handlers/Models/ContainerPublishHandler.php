...
/**
* Handles API requests for ContainerPublish
*/
class ContainerPublishHandler extends ApiHandler
{
	...
	public function handleGet(ApiRequest $request)
	{
		...
		return $this->handleGetDefault($request, new ContainerPublish);
	}
	...
	public function handlePut(ApiRequest $request)
	{
		...
		return $this->handlePutDefault($request, new ContainerPublish);
	}
}