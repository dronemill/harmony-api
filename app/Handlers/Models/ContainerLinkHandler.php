...
/**
* Handles API requests for ContainerLink
*/
class ContainerLinkHandler extends ApiHandler
{
	...
	public function handleGet(ApiRequest $request)
	{
		...
		return $this->handleGetDefault($request, new ContainerLink);
	}
	...
	public function handlePut(ApiRequest $request)
	{
		...
		return $this->handlePutDefault($request, new ContainerLink);
	}
}